          ...
          <div className="flex flex-col items-center gap-3 bg-muted/30 border border-border/60 p-5 rounded-2xl shrink-0 min-w-[210px]">
            ...
            <div className="flex items-center gap-2">
              {isClockedIn ? (
                <button
                  disabled
                  className="flex items-center justify-center gap-1.5 bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 px-4 py-2 rounded-xl text-xs font-bold shadow-xs cursor-not-allowed opacity-90"
                >
                ...
                <button
                  disabled
                  className="flex items-center justify-center gap-1.5 bg-primary/70 text-white px-4 py-2 rounded-xl text-xs font-bold shadow-xs cursor-not-allowed"
                >
