...
const Employees = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      Object.entries({ ...formData, role: 'EMPLOYEE' }).forEach(([k, v]) => fd.append(k, v || ''));
              ...
              <div className="flex flex-col gap-2 border border-dashed border-border/60 rounded-xl p-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    />
                    <label htmlFor="edit-employee-pic" className="cursor-pointer inline-flex items-center gap-1.5 rounded-lg border border-border bg-muted/40 px-3 py-1.5 text-xs font-semibold hover:bg-muted">
