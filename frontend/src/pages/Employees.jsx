            ...
            {users.length === 0 ? (
              ...
              users.map((item) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-xs text-muted-foreground max-w-[200px] truncate">{item.email}</td>
                  <td className="px-6 py-4 text-xs font-medium text-foreground">{item.department || 'Engineering'}</td>
                  <td className="px-6 py-4" onClick={(e) => e.stopPropagation()}>
                    <button
